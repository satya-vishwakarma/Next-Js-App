  ...
  const QuickMenuDesktop = () => {
    return (
      <ListGroup
        as="ul"
        bsPrefix="navbar-nav"
        className="navbar-right-wrap d-flex nav-top-wrap ms-auto"
      >
        <Dropdown as="li" className="stopevent">
          ...
          >
            <Dropdown.Item className="mt-3" bsPrefix=" " as="div">
              <div className="border-bottom d-flex justify-content-between align-items-end px-3 pb-3 pt-0">
          ...
          >
            <Dropdown.Item as="div" className="px-4 pb-0 pt-2" bsPrefix=" ">
              <div className="lh-1 ">
                ...
                <Link href="#" className="fs-6 text-inherit">
                  View my profile
                </Link>
              </div>
              <div className=" dropdown-divider mb-2 mt-3"></div>
            </Dropdown.Item>
