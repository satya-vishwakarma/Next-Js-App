        ...
        <Card>
          ...
          <Card.Body>
            <Row className="align-items-center">
              <Col lg={6} md={12} xs={12} className="mb-lg-0 mb-4">
                <div className="mb-lg-0 mb-3">
                  <Form.Check id="shippingBillingAddress1">
                    ...
                    />
                    <Form.Check.Label>
                      <span className="d-block text-dark fw-bold mb-3">
                      ...
                      <Link href="#" className="link-success me-2">
                        Edit
                      </Link>
                      <Link href="#" className="link-danger me-2">
                        Delete
                      </Link>
                      <Link
                        href="#"
                        className="text-muted text-primary-hover me-2"
                      >
