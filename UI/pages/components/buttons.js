...
const Buttons = () => {
  return (
    <Container fluid className="p-6">
        ...
        <Col lg={12} md={12} sm={12}>
          <div className="border-bottom d-md-flex align-items-center justify-content-between mb-4 pb-4">
            <div className="mb-md-0 mb-3">
              <h1 className="h2 fw-bold mb-1">Buttons</h1>
              <p className="mb-0 ">
              ...
              <Card.Body className="p-0">
                <Tab.Content>
                  <Tab.Pane eventKey="design" className="p-4 pb-4">
                    ...
                    <Button variant="link" className="mb-2 me-1">
                      Link
                    </Button>
                  </Tab.Pane>
          ...
          <Tab.Container defaultActiveKey="design">
            <Card>
              ...
              <Card.Body className="p-0">
                <Tab.Content>
                  <Tab.Pane eventKey="design" className="p-4 pb-4">
                    <Button href="#" className="mb-2 me-1">
                      Link
                    </Button>
                    <Button type="submit" className="mb-2 me-1">
                      Button
                    </Button>
                    <Button
                      as="input"
              ...
              <Card.Body className="p-0">
                <Tab.Content>
                  <Tab.Pane eventKey="design" className="p-4 pb-4">
                    ...
                    <Button variant="primary" size="sm" className="mb-2 me-1">
                      Small button
                    </Button>
                    <Button variant="primary" size="xs" className="mb-2 me-1">
                      Xtra Small button
                    </Button>
                  </Tab.Pane>
                  <Tab.Pane eventKey="react" className="react-code p-4 pb-4">
            ...
            <Card>
              ...
              <Card.Body className="p-0">
                <Tab.Content>
                  <Tab.Pane eventKey="design" className="p-4 pb-4">
                    <Row>
                      <Col md={6} className="d-grid mx-auto gap-2">
                        <Button variant="primary">Button</Button>
                        <Button variant="primary">Button</Button>
                      </Col>
                    </Row>
      ...
      <Row>
        <Col xl={12} lg={12} md={12} sm={12}>
          <div className="mb-3 mt-5">With fixed width and height.</div>
          <Tab.Container defaultActiveKey="design">
            <Card>
              <Card.Header className="border-bottom-0 p-0 ">
                <Nav className="nav-lb-tab">
      ...
      <Row>
        <Col xl={12} lg={12} md={12} sm={12}>
          <div className="mb-3 mt-5">Also available in all button sizes.</div>
          <Tab.Container defaultActiveKey="design">
            <Card>
              <Card.Header className="border-bottom-0 p-0 ">
                <Nav className="nav-lb-tab">
